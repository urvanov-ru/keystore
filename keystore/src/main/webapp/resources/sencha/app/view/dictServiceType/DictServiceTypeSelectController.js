Ext.define('KeyStore.view.dictServiceType.DictServiceTypeSelectController', {
    extend : 'Ext.app.ViewController',
    requires : [],
    alias : 'controller.dictServiceTypeSelect',
    
    onGridRender : function(self, eOpts) {
        this.getViewModel().getStore('dictServiceTypeSelectStore').load();
    },
