Ext.define('KeyStore.view.client.LinkClientDictActionListController', {
    extend : 'Ext.app.ViewController',
    requires : [],
    alias : 'controller.linkClientDictActionList',
    ...
    onRemoveClick : function (self) {
        ...
        if (selected.length > 0) {
            ...
            globalUtils.ajaxRequest({
                url : '/client/removeLinkClientDictAction',
                jsonData : {
                    ...
                    try {
                        ...
                        if (answer.success) {
                            Ext.MessageBox.show({
                                ...
                                fn : function () {
                                    controller.getViewModel().getStore('linkClientDictActionListStore').reload();
                                }
                            });
                        } else {
                            if (console)
    ...
    loadData : function (obj) {
        ...
        this.getViewModel().getStore('linkClientDictActionListStore').load({
            params : {
